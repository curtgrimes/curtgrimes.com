...
export default {
  ...
  jsonld() {
    return {
      ...
      knowsAbout: [].concat(...skills.map(s => s.examples.map(e => e.name))),
      ...
      worksFor: [
        {
          ...
          sameAs: [
            "https://niu.edu",
            "https://twitter.com/niulive",
            "https://www.facebook.com/NorthernIllUniv/",
            "https://www.linkedin.com/school/northern-illinois-university/"
          ]
        }
      ]
    };
